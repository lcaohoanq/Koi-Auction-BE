...
--
-- Máy chủ: azdb-koiauction.mysql.database.azure.com:3306
-- Thời gian đã tạo: Th10 01, 2024 lúc 10:46 AM
-- Phiên bản máy phục vụ: 8.0.37-azure
...
INSERT INTO `auctions` (`id`, `end_time`, `start_time`, `status`, `title`, `auctioneer_id`) VALUES
(1, '2024-10-30 14:41:38.679000', '2024-10-06 14:41:38.679000', 'ENDED', 'Fixed Price Auction', 23),
(2, '2024-10-30 14:41:38.679000', '2024-10-06 14:41:38.679000', 'ENDED', 'Sealed Price Auction', 23),
(3, '2024-10-17 14:35:00.000000', '2024-10-15 14:35:00.000000', 'ENDED', 'Test Auction', 21),
(4, '2024-10-17 16:50:00.000000', '2024-10-15 16:50:00.000000', 'ENDED', 'Decs Auction Test', 21),
(5, '2024-11-09 08:08:00.000000', '2024-11-01 08:07:00.000000', 'UPCOMING', 'Auction 1', 22),
(6, '2024-11-09 08:23:00.000000', '2024-10-31 08:26:00.000000', 'ONGOING', 'Auction 2', 22);
...
INSERT INTO `auction_kois` (`id`, `base_price`, `bid_method`, `bid_step`, `ceil_price`, `current_bid`, `current_bidder_id`, `is_sold`, `revoked`, `auction_id`, `koi_id`) VALUES
(1, 200000, 'FIXED_PRICE', 0, NULL, 200000, 2, 1, 0, 1, 117),
...
(1, '2023-06-05 00:00:00.000000', '2024-10-31 08:09:39.726538', 1, 'A beautiful Doitsu Showa koi', 1, 26, 'Doitsu Showa', 558, 'Female', 'VERIFIED', 'https://mjjlqhnswgbzvxfujauo.supabase.co/storage/v1/object/public/auctions/3/photos/Shinoda%20Doitsu%20Showa%2026cm%20tosai.png', 3, 26),
(2, '2023-03-14 00:00:00.000000', '2024-10-31 08:09:50.439481', 1, 'A beautiful Showa koi', 0, 26, 'Showa', 561, 'Female', 'VERIFIED', 'https://mjjlqhnswgbzvxfujauo.supabase.co/storage/v1/object/public/auctions/3/photos/Isa%20Showa%20Tosai%2026cm.png', 3, 27),
(3, '2024-05-18 00:00:00.000000', '2024-10-30 16:26:26.985954', 1, 'A beautiful Showa koi', 1, 27, 'Showa', 444, 'Female', 'VERIFIED', 'https://mjjlqhnswgbzvxfujauo.supabase.co/storage/v1/object/public/auctions/3/photos/Isa%20Showa%20Tosai%2027cm.png', 3, 28),
...
(97, '2023-06-22 00:00:00.000000', '2024-10-26 23:28:39.177451', 1, 'A beautiful Doitsu Shiro Utsuri koi', 1, 28, 'Doitsu Shiro Utsuri', 176, 'Female', 'SOLD', 'https://mjjlqhnswgbzvxfujauo.supabase.co/storage/v1/object/public/auctions/4/photos/Omosako%20Tosai%20Doitsu%20Shiro%20Utsuri%2028cm.png', 4, 30),
...
(123, '2024-07-27 00:00:00.000000', '2024-10-25 23:11:13.603255', 3, 'A beautiful Ginrin Showa koi', 1, 55, 'Ginrin Showa', 597, 'Female', 'SOLD', 'https://mjjlqhnswgbzvxfujauo.supabase.co/storage/v1/object/public/auctions/5/photos2/31-55%20Gin%20Rin%20Showa.png', 3, 24),
...
(397, '2023-12-28 00:00:00.000000', '2024-10-31 08:37:21.886424', 2, 'A beautiful Golden Corn koi', 0, 54, 'Golden Corn', 2000, 'Female', 'VERIFIED', 'https://mjjlqhnswgbzvxfujauo.supabase.co/storage/v1/object/public/auctions/65%20Big%20Auction/photos/Golden%20Corn%2048cm.png', 20, 30),
...
(400, '2024-09-09 00:00:00.000000', '2024-10-31 08:37:23.019729', 2, 'A beautiful Kohaku koi', 0, 61, 'Kohaku', 1000, 'Female', 'VERIFIED', 'https://mjjlqhnswgbzvxfujauo.supabase.co/storage/v1/object/public/auctions/65%20Big%20Auction/photos/kOHAKU%20Dainichi.png', 1, 31),
(401, '2024-10-31 08:31:58.325842', '2024-10-31 08:37:12.236557', 10, 'CA DEP TUYET VOI', 0, 30, 'KOI111', 3000, 'FEMALE', 'VERIFIED', 'https://static.vecteezy.com/system/resources/previews/019/046/451/original/koi-carp-fish-png.png', 19, 25);
...
CREATE TABLE `orders` (
  ...
  `status` enum('CANCELLED','DELIVERED','PENDING','PROCESSING','SHIPPING','COMPLETED') DEFAULT NULL,
...
INSERT INTO `orders` (`id`, `active`, `address`, `email`, `first_name`, `last_name`, `note`, `order_date`, `payment_method`, `phone_number`, `shipping_address`, `shipping_date`, `shipping_method`, `status`, `total_money`, `tracking_number`, `user_id`) VALUES
(1, b'0', 'Quang Binh, Viet Nam', 'son@gmail.com', 'Son', 'Cong Duong', '12345', '2024-10-18', 'Cash', '0562278326', 'Á', NULL, 'Standard', 'CANCELLED', 500000, NULL, 2),
(2, b'1', 'Da Nang, Viet Nam', 'duongnmse181515@fpt.edu.vn', 'Duong', 'Duong', NULL, '2024-10-18', 'Cash', '', 'Da Nang, Viet Nam', '2024-10-30', 'Standard', 'COMPLETED', 500000, NULL, 19),
(3, b'0', 'Da Nang, Viet Nam', 'duongnmse181515@fpt.edu.vn', 'Duong', 'Duong', '123123', '2024-10-18', 'Payment', '031241233', 'Da Nang, Viet Nam', NULL, 'Standard', 'CANCELLED', 500000, NULL, 19),
(4, b'0', 'Quang Binh, Viet Nam', 'son@gmail.com', 'Son', 'Cong Duong', NULL, '2024-10-18', 'Cash', '', 'Quang Binh, Viet Nam', '2024-10-18', 'Standard', 'CANCELLED', 500000, NULL, 2),
(5, b'1', 'Quang Binh, Viet Nam', 'son@gmail.com', 'Son', 'Cong Duong', 'anh bay den roiiiiiii', '2024-10-25', 'Payment', '0348018758', 'Quang Binh, Viet Nam', '2024-10-26', 'Standard', 'COMPLETED', 10000, NULL, 2);
...
INSERT INTO `payments` (`id`, `payment_amount`, `payment_date`, `payment_method`, `payment_status`, `payment_type`, `order_id`, `user_id`, `bank_number`) VALUES
(1, 500000, '2024-10-18 05:00:13.000000', 'Cash', 'SUCCESS', 'ORDER', 1, 2, NULL),
...
(43, '2024-11-23 18:21:06.055440', b'0', 1, '2024-12-23 18:21:06.055757', '7b1bfeeb-d3fb-43a2-93e8-52af8dfc9755', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjIsImVtYWlsIjoic29uQGdtYWlsLmNvbSIsInN1YiI6InNvbkBnbWFpbC5jb20iLCJleHAiOjE3MzIzNjA4NjV9.Y2fZQaWZ5YtgipbSJ6yEnvgg0GM3VArlLYx4rfUeleI', 'Bearer', 2),
(46, '2024-11-24 00:23:49.099398', b'0', 1, '2024-12-24 00:23:49.099621', '4ac50df0-7763-4309-98bd-95d052360afd', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjI3LCJlbWFpbCI6ImlzYUBnbWFpbC5jb20iLCJzdWIiOiJpc2FAZ21haWwuY29tIiwiZXhwIjoxNzMyMzgyNjI4fQ.Zi3QF0JN-wXh4B5D7tE2l_eGc7zeZicSwVbbSymibxU', 'Bearer', 27),
(48, '2024-11-24 01:04:02.233758', b'0', 0, '2024-12-24 01:04:02.233758', 'd47346b5-56e6-4014-9bf1-64d8d7afa2a3', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjIzLCJlbWFpbCI6Im1hbmh0cmFuQGdtYWlsLmNvbSIsInN1YiI6Im1hbmh0cmFuQGdtYWlsLmNvbSIsImV4cCI6MTczMjM4NTA0Mn0.03hdwvC2HR_aZGGLc5RnInz9NjQtWCatCOG5Mu_kMcA', 'Bearer', 23),
(50, '2024-11-24 07:45:00.706757', b'0', 1, '2024-12-24 07:45:00.707139', 'aa2f131d-cd84-4053-83e4-bc4bd912be25', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjIsImVtYWlsIjoic29uQGdtYWlsLmNvbSIsInN1YiI6InNvbkBnbWFpbC5jb20iLCJleHAiOjE3MzI0MDkxMDB9.ktxIapz7ZQ459QfrwT9fYYb8pxCw-oQndwJhv9J8j7Q', 'Bearer', 2),
(55, '2024-11-24 16:26:27.137818', b'0', 0, '2024-12-24 16:26:27.137818', '825d4727-6c85-4f6a-a1fa-342469b0fa3c', b'0', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjIzLCJlbWFpbCI6Im1hbmh0cmFuQGdtYWlsLmNvbSIsInN1YiI6Im1hbmh0cmFuQGdtYWlsLmNvbSIsImV4cCI6MTczMjQ0MDM4Nn0.W8Fs6nqG047kffEwZ1ibKuiYfhG8ukH8fO5YYqAHWPo', 'Bearer', 23),
(59, '2024-11-24 23:06:24.241476', b'0', 0, '2024-12-24 23:06:24.241476', '114d128d-6619-40c8-b249-e67c0fa37279', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjI0LCJlbWFpbCI6Im5uZEBnbWFpbC5jb20iLCJzdWIiOiJubmRAZ21haWwuY29tIiwiZXhwIjoxNzMyNDY0Mzg0fQ.F8K-iV6__qu7fGKahDteqCQyOudGVNY3xS7jI8Amy1M', 'Bearer', 24),
(60, '2024-11-25 00:23:44.697717', b'0', 0, '2024-12-25 00:23:44.697717', 'ae300671-7f3a-4cc7-bef7-ecc6e8e81b44', b'0', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjI2LCJlbWFpbCI6InNha2FpQGdtYWlsLmNvbSIsInN1YiI6InNha2FpQGdtYWlsLmNvbSIsImV4cCI6MTczMjQ2OTAyNH0.R8cuBg2ahJTxMrmsA32hkP9SVZG7t6by9_xpim4ESvE', 'Bearer', 26),
(62, '2024-11-25 21:44:42.917682', b'0', 0, '2024-12-25 21:44:42.917682', '9274f3a6-8824-4459-9dc4-7af5be656e79', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjIzLCJlbWFpbCI6Im1hbmh0cmFuQGdtYWlsLmNvbSIsInN1YiI6Im1hbmh0cmFuQGdtYWlsLmNvbSIsImV4cCI6MTczMjU0NTg4Mn0.BbWyCWLawYkY_zIj7_r1dl-taI8rcCtnAhd7HemD8Vs', 'Bearer', 23),
(63, '2024-11-25 23:28:22.897818', b'0', 0, '2024-12-25 23:28:22.898819', 'b203029f-137e-4723-aa29-4703d4c38a15', b'0', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjMwLCJlbWFpbCI6InNoaW5vZGFAZ21haWwuY29tIiwic3ViIjoic2hpbm9kYUBnbWFpbC5jb20iLCJleHAiOjE3MzI1NTIxMDJ9.HtKYanwbyGj_IPk4A-Q7v_hHaNdQeUSDMmXklQa0A8c', 'Bearer', 30),
(64, '2024-11-25 23:28:23.880896', b'0', 0, '2024-12-25 23:28:23.880896', '25bdcd91-b940-4de6-ad92-771618d9a831', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjMwLCJlbWFpbCI6InNoaW5vZGFAZ21haWwuY29tIiwic3ViIjoic2hpbm9kYUBnbWFpbC5jb20iLCJleHAiOjE3MzI1NTIxMDN9.lTu8w3g7lGTh0ZoIVNh8QFuk8EkhiivZV1hgkR5FoAw', 'Bearer', 30),
(69, '2024-11-26 10:04:31.333655', b'0', 1, '2024-12-26 10:04:31.333875', 'c1b180b8-2d3c-4f8a-8fbb-5d1aafd8b4b1', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjI3LCJlbWFpbCI6ImlzYUBnbWFpbC5jb20iLCJzdWIiOiJpc2FAZ21haWwuY29tIiwiZXhwIjoxNzMyNTkwMjcxfQ.jstv7faQE_z5hyxiNHbJAw6IIzN4MJGL3nA2opFnPfc', 'Bearer', 27),
(79, '2024-11-27 15:17:50.040005', b'0', 0, '2024-12-27 15:17:50.040005', '0566a7e2-8d28-4003-bdbd-b7e7b923da04', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjE5LCJlbWFpbCI6ImR1b25nbm1zZTE4MTUxNUBmcHQuZWR1LnZuIiwic3ViIjoiZHVvbmdubXNlMTgxNTE1QGZwdC5lZHUudm4iLCJleHAiOjE3MzI2OTU0NTJ9.Qmp3-a7CBiJs94vsjguEVM96Cl0pfZITN5KWmAmhFcQ', 'Bearer', 19),
(80, '2024-11-27 15:18:01.640286', b'0', 0, '2024-12-27 15:18:01.640286', 'd9378122-6178-4c0a-8d8b-681d307d136c', b'0', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjE5LCJlbWFpbCI6ImR1b25nbm1zZTE4MTUxNUBmcHQuZWR1LnZuIiwic3ViIjoiZHVvbmdubXNlMTgxNTE1QGZwdC5lZHUudm4iLCJleHAiOjE3MzI2OTU0Nzh9.mce4wyOU9pZ15jH8N6xzc_KH7QuyXBzYGzE2XZSbMA0', 'Bearer', 19),
(81, '2024-11-27 23:40:05.260255', b'0', 0, '2024-12-27 23:40:05.260255', 'fa7838a0-d031-4f15-8c40-7bdaeeed3b0f', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjE5LCJlbWFpbCI6ImR1b25nbm1zZTE4MTUxNUBmcHQuZWR1LnZuIiwic3ViIjoiZHVvbmdubXNlMTgxNTE1QGZwdC5lZHUudm4iLCJleHAiOjE3MzI3MjU2MDV9.qz9rwVezzPaE3HXicDZfOz64z9rhKsxP7qVo6DbL5eI', 'Bearer', 19),
(93, '2024-11-28 11:25:19.300540', b'0', 0, '2024-12-28 11:25:19.300540', '30d4cf62-0c77-44d2-a9a3-adb9589347b9', b'0', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjIwLCJlbWFpbCI6Im1hbmhkdW9uZ2xocDRAZ21haWwuY29tIiwic3ViIjoibWFuaGR1b25nbGhwNEBnbWFpbC5jb20iLCJleHAiOjE3MzI3Njc5MTh9.xju5f6PQzklKq24vjtAKjPWygp6kW7bQ_MwIKYib-_4', 'Bearer', 20),
(131, '2024-11-29 21:20:57.333320', b'0', 0, '2024-12-29 21:20:57.333320', '0635bf08-90f3-48a0-b7cb-4ccd613a6599', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjI3LCJlbWFpbCI6ImlzYUBnbWFpbC5jb20iLCJzdWIiOiJpc2FAZ21haWwuY29tIiwiZXhwIjoxNzMyODkwMDU3fQ.1TC_NHpBP7Bv6hCVVqhRZvYl7ie9hb-T2JvPMIEiju8', 'Bearer', 27),
(146, '2024-11-30 08:07:32.736937', b'0', 0, '2024-12-30 08:07:32.737999', '2f78c3ad-c7f9-475f-a124-fe31d7ca6afe', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjM4LCJlbWFpbCI6ImhvYW5nY2x3QGdtYWlsLmNvbSIsInN1YiI6ImhvYW5nY2x3QGdtYWlsLmNvbSIsImV4cCI6MTczMjkyODg1Mn0.zXVMOQ9aLHuJxCWO8WXDgV_AlgF5s5Fu6apfurKy0kI', 'Bearer', 38),
(150, '2024-11-30 08:23:22.355011', b'0', 0, '2024-12-30 08:23:22.356003', 'c454595e-6dcc-4e26-8217-cbddc7e0d22b', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjM4LCJlbWFpbCI6ImhvYW5nY2x3QGdtYWlsLmNvbSIsInN1YiI6ImhvYW5nY2x3QGdtYWlsLmNvbSIsImV4cCI6MTczMjkyOTgwMn0.-N5nsxKePnAj3XZEkY_sefsg5L2SmLRR93gU7cIcdiI', 'Bearer', 38),
(151, '2024-11-30 08:24:18.565228', b'0', 0, '2024-12-30 08:24:18.565228', 'a1d9c136-f9d2-4d26-964e-e616711d0c47', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjIyLCJlbWFpbCI6ImJhb3Z1QGdtYWlsLmNvbSIsInN1YiI6ImJhb3Z1QGdtYWlsLmNvbSIsImV4cCI6MTczMjkyOTg1N30.Hil6402hrvHfX9sSNGXng-d5lwC_xpREaRGNEB5oa1c', 'Bearer', 22),
(152, '2024-11-30 08:24:55.508277', b'0', 0, '2024-12-30 08:24:55.508277', 'e3bbce4d-12a9-4098-a1c2-5eae17635f2e', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjI1LCJlbWFpbCI6Im1hcnVzaGluQGdtYWlsLmNvbSIsInN1YiI6Im1hcnVzaGluQGdtYWlsLmNvbSIsImV4cCI6MTczMjkyOTg5NX0.v2qgTJiR2mPhLun8ALbGDR339Js-VvNYSs9F2bHNUP4', 'Bearer', 25),
(153, '2024-11-30 08:26:09.612494', b'0', 0, '2024-12-30 08:26:09.612494', '52ac35b1-ccef-4483-8c8b-9d6c731cb253', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjIsImVtYWlsIjoic29uQGdtYWlsLmNvbSIsInN1YiI6InNvbkBnbWFpbC5jb20iLCJleHAiOjE3MzI5Mjk5Njl9.G03h89_1oytfIwH76NFqpvJuaYu5E25cfAKP9Bb5XXQ', 'Bearer', 2),
(154, '2024-11-30 08:26:33.625742', b'0', 0, '2024-12-30 08:26:33.625742', '0e129b21-211d-49c0-8820-412d451a5117', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjIyLCJlbWFpbCI6ImJhb3Z1QGdtYWlsLmNvbSIsInN1YiI6ImJhb3Z1QGdtYWlsLmNvbSIsImV4cCI6MTczMjkyOTk5M30.i2CcScgubFjbN_zH2cRq4Y35n2eWvbe4w3O3ibJfVxQ', 'Bearer', 22),
(155, '2024-11-30 08:27:33.770917', b'0', 0, '2024-12-30 08:27:33.771896', '692363d3-7d5f-474a-8992-5d841575d11b', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjM4LCJlbWFpbCI6ImhvYW5nY2x3QGdtYWlsLmNvbSIsInN1YiI6ImhvYW5nY2x3QGdtYWlsLmNvbSIsImV4cCI6MTczMjkzMDA1M30.XIDaKSzkTImArL9mLiCPLxGd_cxV4r5fxysPFUj7ch4', 'Bearer', 38),
(156, '2024-11-30 08:28:34.034673', b'0', 0, '2024-12-30 08:28:34.034673', 'f0a91926-6039-42cb-a0c8-a0915fbb586a', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjI1LCJlbWFpbCI6Im1hcnVzaGluQGdtYWlsLmNvbSIsInN1YiI6Im1hcnVzaGluQGdtYWlsLmNvbSIsImV4cCI6MTczMjkzMDExM30.tspIxtqebFW5QqzQwes3Fe0Fp09NuCNcJ5hvqeFSsOM', 'Bearer', 25),
(157, '2024-11-30 08:32:49.670946', b'0', 0, '2024-12-30 08:32:49.670946', 'fd40aabb-4765-4474-8391-0efd07900cab', b'1', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjIyLCJlbWFpbCI6ImJhb3Z1QGdtYWlsLmNvbSIsInN1YiI6ImJhb3Z1QGdtYWlsLmNvbSIsImV4cCI6MTczMjkzMDM2OX0.UJtoDWhDts64ON8p-T863y4SRoAFShP_2yApn2asw2w', 'Bearer', 22),
(158, '2024-11-30 08:38:14.028940', b'0', 0, '2024-12-30 08:38:14.028940', 'aea87f31-e046-4d65-8a7b-36dcc9caf6e1', b'0', 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjI1LCJlbWFpbCI6Im1hcnVzaGluQGdtYWlsLmNvbSIsInN1YiI6Im1hcnVzaGluQGdtYWlsLmNvbSIsImV4cCI6MTczMjkzMDY5M30.gCmUwOh1zMaxg0IxJGM2TiwQPHxWDN4MG0x51Di5KDg', 'Bearer', 25);
...
INSERT INTO `users` (`id`, `created_at`, `updated_at`, `account_balance`, `address`, `avatar_url`, `date_of_birth`, `email`, `first_name`, `google_account_id`, `is_active`, `is_subscription`, `last_name`, `password`, `phone_number`, `status`, `role_id`) VALUES
(1, '2024-09-22 12:52:28.527956', '2024-09-22 12:52:28.527967', 0, '', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', NULL, 'mnhw.0612@gmail.com', 'Minh', 0, 1, 0, 'Nhu', '$2a$10$Fr4Khr9gT8rBlSlZIF3Z3.t62ZenOSFVJamccBe5yxLB27SSvF0Ru', NULL, NULL, 1),
(2, '2024-09-22 06:58:19.000000', '2024-10-27 09:54:10.814280', 797378831, 'Quang Binh, Viet Nam', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '1979-10-13 00:00:00.000000', 'son@gmail.com', 'Son', 0, 1, 0, 'Cong Duong', '$2a$10$Orep8r6WJo5EjwNq7HyTL.kD8xDlwD5QA6Qk2HVQzkVjUXG1ccGPm', NULL, 'UNVERIFIED', 1),
(3, '2024-09-22 06:58:39.749509', '2024-09-22 06:58:39.749513', 0, 'Tam Ki, Viet Nam', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '1979-10-13 00:00:00.000000', 'manhduonglhp1@gmail.com', 'Duong', 0, 1, 0, 'Manh Nguyen', '$2a$10$Rg7wfZ2yabht3eBqhoJQxedR.r4ojQUGm9g9Jz5WtDJw3pWqpoiTu', NULL, 'UNVERIFIED', 1),
(4, '2024-09-27 15:21:18.973575', '2024-09-27 15:21:18.973595', 0, 'Hoa Khanh, Da Nang', NULL, '2004-10-14 00:00:00.000000', 'hoangdz1604@gmail.com', 'Bao', 0, 0, 0, 'Chau', '$2a$10$jX.17d38A.AXWWJedIQ4p..KzZkKt.Pk3bwpU5gtPJLJtzygdjoy.', NULL, NULL, 1),
(5, '2024-09-27 15:25:59.286318', '2024-09-27 15:25:59.286337', 0, 'Hoa Vang, Da Nang', NULL, '2004-10-14 00:00:00.000000', 'luuhai@gmail.com', 'Hai', 0, 0, 0, 'Luu', '$2a$10$SwG2quSV3SQNdAfKWpZd0uzaB9XwoaBfR8n27D9QptspytMyNkj3u', NULL, NULL, 1),
(6, '2024-09-27 15:28:51.559247', '2024-09-27 15:28:51.559286', 0, 'Hoa Vang, Da Nang', NULL, '2004-10-14 00:00:00.000000', 'luuhaivn@gmail.com', 'Hai', 0, 0, 0, 'Luu', '$2a$10$MmAaEStq3KT7fRhKWlD8FOXL6GdTk1e.5BjPISpZunxAxCq5pGbwq', NULL, 'UNVERIFIED', 1),
(7, '2024-09-27 15:30:52.640808', '2024-09-27 15:30:52.640833', 0, 'Hoa Vang, Da Nang', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '2004-10-14 00:00:00.000000', 'lch@gmail.com', 'Hoang', 0, 0, 0, 'Hai', '$2a$10$63eAnEyqY4Y3xsktquBzJ.u39j/X8b.1NcafBdXSvx7Y0wai1hIxm', NULL, 'UNVERIFIED', 1),
(8, '2024-09-28 01:42:59.705789', '2024-09-28 01:42:59.705833', 0, 'Vinh Long', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '2004-10-14 00:00:00.000000', 'mah@gmail.com', 'Mac', 0, 0, 0, 'Hao Anh', '$2a$10$lwZzBtJFAJjPGRCJvJKlk.Gyd3RhLsV4eFai1BGIQByQjfjAj46xa', NULL, 'UNVERIFIED', 1),
(9, '2024-09-28 02:04:20.784604', '2024-09-28 02:04:20.784678', 0, 'Vinh Long', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '2004-10-14 00:00:00.000000', 'manhduonglhp2@gmail.com', 'Mac', 0, 1, 0, 'Hao Anh', '$2a$10$M3WCdcgsRAW.zfCyf2kQwODnDFHm0fCExajXE74gR8Dq4WJZvGN2O', NULL, 'UNVERIFIED', 1),
(10, '2024-09-28 02:09:21.078020', '2024-09-28 02:09:21.078121', 0, 'Vinh Long', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '2004-10-14 00:00:00.000000', 'manhduonglhp3@gmail.com', 'Mac', 0, 1, 0, 'Hao Anh', '$2a$10$pDVmvBj9Bs7/A8OVQ5nUzeQoCE4F95CU3ggA88cxHTveueEtpjvTe', NULL, 'UNVERIFIED', 1),
(11, '2024-09-28 02:15:37.103176', '2024-09-28 02:15:37.103200', 0, 'Vinh Long', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '2004-10-14 00:00:00.000000', 'manhduonglhp5@gmail.com', 'Mac', 0, 1, 0, 'Hao Anh', '$2a$10$4evUxJ397YXsiexQ7yTMC.67GpQ9lSBCda4DvxA2aYQ833XCB89fW', NULL, 'UNVERIFIED', 1),
(12, '2024-09-28 08:05:35.248602', '2024-09-28 08:05:35.248634', 0, 'Tokyo', 'https://auctionkoi.com/images/shintaro-logo.png', NULL, 'test4@gmail.com', 'hehe', 0, 1, 0, 'taolanhat', '$2a$10$ZwV/1YUWzLeG3mMR1GIFnujiezIBvwvdzLcrTcABwA2DM8NlKPc0G', NULL, 'UNVERIFIED', 1),
(13, '2024-09-28 09:00:08.369215', '2024-09-28 09:03:04.120112', 0, 'TPHCM', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTTfSLvr6JNIBOy0OBG-ydUSOhjq7Y7KDRvg&s', NULL, 'hoanglcse181513@fpt.edu.vn', 'Hoang', 0, 1, 0, 'Cao Luu', '$2a$10$shSYCgMKePpgyXhjDXdJ.e0LUTivx3mQCjJOmsSmBnKjJYjD9mEWu', NULL, 'VERIFIED', 1),
(14, '2024-09-30 08:26:46.220241', '2024-09-30 08:26:46.220247', 0, 'TPHCM', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTTfSLvr6JNIBOy0OBG-ydUSOhjq7Y7KDRvg&s', NULL, 'caohoanggt0@gmail.com', 'Hoang', 0, 1, 0, 'Cao Luu', '$2a$10$BGSucPFP/s1A1NCAG5MRDe/36W04uVJzp0Ala7YKtOzUS8anAC1W.', NULL, 'UNVERIFIED', 1),
(15, '2024-10-01 02:37:30.758899', '2024-10-01 02:37:30.758902', 0, 'Tra Bui', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', NULL, 'luu1231604@gmail.com', 'Hoang', 0, 1, 0, 'Luu', '$2a$10$AFB6FiL9C931yESMHntJf.iB/wQN3nFzhnFJEMREffrUKWcPQfoUy', NULL, 'UNVERIFIED', 1),
(16, '2024-10-01 02:40:15.418332', '2024-10-01 02:40:15.418334', 0, 'Tra Bong', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', NULL, 'testetet@gmail.com', 'Hoang', 0, 1, 0, 'Luu', '$2a$10$NaE3c0NGEZGS.ZritlyvD.pcff84D8e.0Y0opMYdQZsOUXUcJYUvC', NULL, 'UNVERIFIED', 1),
(17, '2024-10-01 02:41:55.837629', '2024-10-01 02:41:55.837632', 0, 'Thai Sau', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', NULL, 'hehe@gmail.com', 'Hoang', 0, 1, 0, 'Luu', '$2a$10$v/I9kSV3sH35xejKElfedOWBrgDBqN922.AetAs5ae3sTRRU8CmxW', NULL, 'UNVERIFIED', 1),
(18, '2024-10-01 02:46:13.663828', '2024-10-01 02:48:20.669047', 0, 'Can Gio', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', NULL, 'luukaohoang1604@gmail.com', 'Hoang', 0, 1, 0, 'Luu', '$2a$10$t5Gsz29f8N9.zV21DRGM0OMyDqaxRjClIJSiv9liA36Ff8atzdrAC', NULL, 'VERIFIED', 1),
(19, '2024-10-05 16:11:14.000000', '2024-10-29 08:09:57.657360', 147460537, 'Da Nang, Viet Nam', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '1979-10-13 00:00:00.000000', 'duongnmse181515@fpt.edu.vn', 'Duong', 0, 1, 0, 'Duong', '$2a$10$pXEzC6NCd9r2e6kXNV9PFe9ZJKyyxL/yniNwUl6xpZUy/iQguZQU6', NULL, 'UNVERIFIED', 1),
(20, '2024-10-05 16:11:30.574401', '2024-10-05 16:11:30.574405', 0, 'Da Nang, Viet Nam', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '1979-10-13 00:00:00.000000', 'manhduonglhp4@gmail.com', 'Duong', 0, 1, 0, 'Duong', '$2a$10$s/ICX1aEukr/V7Iz7G/TbOus5yAaayCqKc6DPS9AwrZLf5nbjqAOW', NULL, 'UNVERIFIED', 1),
(21, '2024-09-22 06:56:15.470639', '2024-09-28 07:53:03.281172', 0, 'Ha Tinh, Viet Nam', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '1979-10-13 00:00:00.000000', 'vy@gmail.com', 'Vy', 0, 0, 0, 'Ky Nguyen', '$2a$10$FGoLrPd5YESJhA7iiE3Jf.vnZU1BcxR3N5xtMxOJMKUjknCQ.iK7O', NULL, 'UNVERIFIED', 2),
(22, '2024-09-22 06:57:39.672269', '2024-09-22 06:57:39.672273', 0, 'Ha Nam, Viet Nam', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '1979-10-13 00:00:00.000000', 'baovu@gmail.com', 'Bao', 0, 1, 0, 'Van Vu', '$2a$10$rP7CU.wmF3SaP4lzNHNA6uUQr27JBAJr2Uoot1toTKmRlmGWcg7su', NULL, 'UNVERIFIED', 2),
(23, '2024-09-22 06:57:57.861037', '2024-09-22 06:57:57.861041', 0, 'Phu Tho, Viet Nam', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '1979-10-13 00:00:00.000000', 'manhtran@gmail.com', 'Tran', 0, 1, 0, 'Manh Duc', '$2a$10$nGC/NyBlxwFZzA0Ecj7gP.tYPRIvvFb8DZNNlaM/nylbvU3IzBWGi', NULL, 'UNVERIFIED', 2),
(24, '2024-09-22 06:59:36.244230', '2024-10-25 23:18:12.032816', 100000, 'Tokyo', 'https://auctionkoi.com/images/nnd-logo.png', '1979-10-13 00:00:00.000000', 'nnd@gmail.com', 'NND', 0, 1, 0, 'Farm', '$2a$10$DkiD8VzBXW5pGgGH2cYvQOtT3DbtLsuKHJ9.KjoN.GsI6LSQZJmui', NULL, 'VERIFIED', 3),
(25, '2024-09-22 06:59:53.747779', '2024-09-27 01:23:26.819524', 0, 'Tokyo', 'https://auctionkoi.com/images/marushin-logo.png', '1979-10-13 00:00:00.000000', 'marushin@gmail.com', 'Marushin', 0, 1, 0, 'Farm', '$2a$10$sornl4RV.DkqkAS68ryyw.azD20A/4KmeeOa2IiTRxuS89nUQXMK.', NULL, 'VERIFIED', 3),
(26, '2024-09-22 07:00:02.941910', '2024-10-26 00:39:25.129626', 200000, 'Tokyo', 'https://auctionkoi.com/images/sakai-logo.png', '1979-10-13 00:00:00.000000', 'sakai@gmail.com', 'Sakai', 0, 1, 0, 'Farm', '$2a$10$SecO0EZQEWjBVyok7D7eTeBuVelmz7pjiCA8sddztylvVq801fiRu', NULL, 'VERIFIED', 3),
(27, '2024-09-22 07:00:12.510595', '2024-10-24 23:02:47.195322', 300000, 'Tokyo', 'https://auctionkoi.com/images/isa-logo.png', '1979-10-13 00:00:00.000000', 'isa@gmail.com', 'Isa', 0, 1, 0, 'Farm', '$2a$10$.Wj6q5N.bCR.3dFi3fc2dugPIrA0X91FiibIW/8Kw5mVyYAYjpLei', NULL, 'VERIFIED', 3),
(28, '2024-09-22 07:00:24.623763', '2024-09-27 01:24:49.064092', 0, 'Tokyo', 'https://auctionkoi.com/images/maruhiro-logo.png', '1979-10-13 00:00:00.000000', 'maruhiro@gmail.com', 'Maruhiro', 0, 1, 0, 'Farm', '$2a$10$3TSjJG7bHVlNRdQAi5qBZeeXbLoNhMMXrsFp6FJcC9CFBmrjiV2Su', NULL, 'VERIFIED', 3),
(29, '2024-09-22 07:00:39.043899', '2024-09-27 01:25:04.915762', 0, 'Tokyo', 'https://auctionkoi.com/images/torazo-logo.png', '1979-10-13 00:00:00.000000', 'torazo@gmail.com', 'Torazo', 0, 1, 0, 'Farm', '$2a$10$8sFYFH/3KtoCaV5wiLGhQecY7SwhM.gqFa9G2C1QrC0v2dQaNA0VK', NULL, 'VERIFIED', 3),
(30, '2024-09-22 07:00:50.485396', '2024-10-26 23:28:39.177451', 200000, 'Tokyo', 'https://auctionkoi.com/images/shinoda-logo.png', '1979-10-13 00:00:00.000000', 'shinoda@gmail.com', 'Shinoda', 0, 1, 0, 'Farm', '$2a$10$xGxH5nAWUFgWdo0Twsuc8.6PFhf6ZdgqrvAweQA/kmCj6z9PQKpQi', NULL, 'VERIFIED', 3),
(31, '2024-09-22 12:50:53.030997', '2024-09-27 01:27:52.862485', 0, 'Tokyo', 'https://auctionkoi.com/images/kanno-logo.png', NULL, 'kanno@gmail.com', 'Kanno', 0, 1, 0, 'Farm', '$2a$10$.k6HZRqVtl7sxRtsgjiQ/eOjTpuy4pe7ZwpQKwgA9KwR70WFfeefq', NULL, 'VERIFIED', 3),
(32, '2024-09-27 01:29:07.895187', '2024-09-27 01:32:19.992118', 0, 'Tokyo', 'https://auctionkoi.com/images/dainichi-logo.png', NULL, 'dainichi@gmail.com', 'Dainichi', 0, 1, 0, 'Farm', '$2a$10$XckSkz8ZTZcOGOndc8YTduaPyPdHjj9hQ4PYezMAziSaUTsOgofQO', NULL, 'VERIFIED', 3),
(33, '2024-09-27 01:31:44.803419', '2024-09-27 01:32:22.979260', 0, 'Tokyo', 'https://auctionkoi.com/images/omosako-logo.png', NULL, 'omosako@gmail.com', 'Omosako', 0, 1, 0, 'Farm', '$2a$10$CHmNC2psYO9xeJjzmbSiSe5yAlZzgl5rAN0RYibVMRyARj4YU9ve6', NULL, 'VERIFIED', 3),
(34, '2024-09-27 01:32:46.643498', '2024-09-27 01:33:56.144482', 0, 'Tokyo', 'https://auctionkoi.com/images/izumiya-logo.png', NULL, 'izumiya@gmail.com', 'Izumiya', 0, 1, 0, 'Farm', '$2a$10$iWrH3sir7RQPmn0UHdV0fO5OiLzsVpNtS/u6drxxK1aEilMkycU9S', NULL, 'VERIFIED', 3),
(35, '2024-09-27 01:33:11.046544', '2024-09-27 01:33:58.113222', 0, 'Tokyo', 'https://auctionkoi.com/images/marudo-logo.png', NULL, 'marudo@gmail.com', 'Marudo', 0, 1, 0, 'Farm', '$2a$10$OJa7MR5d3mG6Ju7Bl4NYqO8EOGRDcVzv.GD6m9NtSRK.AsFhakqCO', NULL, 'VERIFIED', 3),
(36, '2024-09-27 01:33:21.593383', '2024-09-27 01:33:59.833681', 0, 'Tokyo', 'https://auctionkoi.com/images/marujyu-logo.png', NULL, 'marujyu@gmail.com', 'Marujyu', 0, 1, 0, 'Farm', '$2a$10$kxEegAgSjIy6yBPcU3Low.Xn9mamaOiU8mnzfehvZ7ltDy4R2ym1a', NULL, 'VERIFIED', 3),
(37, '2024-09-27 01:33:32.619792', '2024-09-27 01:34:01.592871', 0, 'Tokyo', 'https://auctionkoi.com/images/shintaro-logo.png', NULL, 'shintaro@gmail.com', 'Shintaro', 0, 1, 0, 'Farm', '$2a$10$nbKQCdjMw1pEplr.o8ELdOudQWUDtImtQDAfwCQUzsMs8hF6scurW', NULL, 'VERIFIED', 3),
(38, '2024-09-22 06:59:14.042883', '2024-09-22 06:59:14.042887', 0, 'Arab Saudi', 'https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg', '1979-10-13 00:00:00.000000', 'hoangclw@gmail.com', 'Hoang', 0, 1, 0, 'Luu Cao', '$2a$10$W22x0wOuJ5aFtLI1NvN1tO2ZgZhNAq0pEKdLGjsSgSKqJ462qitsO', NULL, 'UNVERIFIED', 4);
